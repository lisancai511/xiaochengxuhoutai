...
module.exports = app => {
  ...
  router.get('/api/fiftysubjectOne', controller.subject.getFiftySubjectOne); // 随机50题
  router.get('/api/fiftysubjectFour', controller.subject.getFiftySubjectFour); // 随机50题
